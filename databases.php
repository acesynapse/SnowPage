...
switch ($urlw) {
  case 'ahirahall.org' || 'www.ahirahall.org';
    ...
    $libir = 'a:0:{}';
    break;
  case 'alleganylibrary.org' || 'www.alleganylibrary.org';
    ...
    $libir = 'a:0:{}';
    break;
  case 'andersonleelibrary.org' || 'www.andersonleelibrary.org';
  ...
  $libir = 'a:0:{}';
  break;
  case 'ashvillelibrary.com' || 'www.ashvillelibrary.com';
  ...
  $libir = 'a:0:{}';
  break;
  case 'barkerlibrary.org' || 'www.barkerlibrary.org';
  ...
  $libir = 'a:0:{}';
  break;
  case 'bemuspointlibrary.org' || 'www.bemuspointlibrary.org';
  ...
  $libir = 'a:0:{}';
  break;
  case 'cattarauguslibrary.org' || 'www.cattarauguslibrary.org';
  ...
  $libir = 'a:0:{}';
  break;
  case 'cfclibrary.org' || 'www.cfclibrary.org';
  ...
  $libir = 'a:0:{}';
  break;
  case 'delevanlibrary.org' || 'www.delevanlibrary.org';
  ...
  $libir = 'a:0:{}';
  break;
  case 'dunkirklibrary.org' || 'www.dunkirklibrary.org';
  $libhours = '';
  $libholi = '';
  $libir = 'a:0:{}';
  break;
  case 'ellicottvillelibrary.org' || 'www.ellicottvillelibrary.org';
  $libhours = '';
  $libholi = '';
  $libir = 'a:0:{}';
  break;
  case 'ellingtonlibrary.org' || 'www.ellingtonlibrary.org';
  $libhours = '';
  $libholi = '';
  $libir = 'a:0:{}';
  break;
  case 'falconerlibrary.org' || 'www.falconerlibrary.org';
  $libhours = '';
  $libholi = '';
  $libir = 'a:0:{}';
  break;
  case 'findleylibrary.org' || 'www.findleylibrary.org';
  $libhours = '';
  $libholi = '';
  $libir = 'a:0:{}';
  break;
  case 'fluvannalibrary.org' || 'www.fluvannalibrary.org';
  $libhours = '';
  $libholi = '';
  $libir = 'a:0:{}';
  break;
  case 'franklinvillelibrary.org' || 'www.franklinvillelibrary.org';
  $libhours = '';
  $libholi = '';
  $libir = 'a:0:{}';
  break;
  case 'gowandalibrary.org' || 'www.gowandalibrary.org';
  $libhours = '';
  $libholi = '';
  $libir = 'a:0:{}';
  break;
  case 'hazeltinelibrary.org' || 'www.hazeltinelibrary.org';
  $libhours = '';
  $libholi = '';
  $libir = 'a:0:{}';
  break;
  case 'kennedyfreelibrary.org' || 'www.kennedyfreelibrary.org';
  $libhours = '';
  $libholi = '';
  $libir = 'a:0:{}';
  break;
  case 'lakewoodlibrary.org' || 'www.lakewoodlibrary.org';
  $libhours = '';
  $libholi = '';
  $libir = 'a:0:{}';
  break;
  case 'littlevalleylibrary.org' || 'www.littlevalleylibrary.org';
  $libhours = '';
  $libholi = '';
  $libir = 'a:0:{}';
  break;
  case 'machiaslibrary.org' || 'www.machiaslibrary.org';
  $libhours = '';
  $libholi = '';
  $libir = 'a:0:{}';
  break;
  case 'mayvillelibrary.com' || 'www.mayvillelibrary.com';
  $libhours = '';
  $libholi = '';
  $libir = 'a:0:{}';
  break;
  case 'minervalibrary.org' || 'www.minervalibrary.org';
  $libhours = '';
  $libholi = '';
  $libir = 'a:0:{}';
  break;
  case 'myerslibrary.org' || 'www.myerslibrary.org';
  $libhours = '';
  $libholi = '';
  $libir = 'a:0:{}';
  break;
  case 'oleanlibrary.org' || 'www.oleanlibrary.org';
  ...
  $libir = 'a:0:{}';
  break;
  case 'pattersonlibrary.org' || 'www.pattersonlibrary.org';
  $libhours = '';
  $libholi = '';
  $libir = 'a:0:{}';
  break;
  case 'portvillelibrary.org' || 'www.portvillelibrary.org';
  $libhours = '';
  $libholi = '';
  $libir = 'a:0:{}';
  break;
  case 'prendergastlibrary.org' || 'www.prendergastlibrary.org';
  $libhours = '';
  $libholi = '';
  $libir = 'a:0:{}';
  break;
  case 'randolphlibrary.info' || 'www.randolphlibrary.info';
  $libhours = '';
  $libholi = '';
  $libir = 'a:0:{}';
  break;
  case 'ripleylibrary.org' || 'www.ripleylibrary.org';
  $libhours = '';
  $libholi = '';
  $libir = 'a:0:{}';
  break;
  case 'salamancalibrary.org' || 'www.salamancalibrary.org';
  $libhours = '';
  $libholi = '';
  $libir = 'a:0:{}';
  break;
  case 'senecalibraries.org' || 'www.senecalibraries.org';
  $libhours = '';
  $libholi = '';
  $libir = 'a:0:{}';
  break;
  case 'sinclairvillelibrary.org' || 'www.sinclairvillelibrary.org';
  $libhours = '';
  $libholi = '';
  $libir = 'a:0:{}';
  break;
  case 'stocktonlibraries.org' || 'www.stocktonlibraries.org';
  $libhours = '';
  $libholi = '';
  $libir = 'a:0:{}';
  break;
  case 'wnyls.org' || 'www.wnyls.org';
  $libhours = 'a:6:{i:0;a:3:{s:7:"weekday";i:1;s:9:"timeStart";s:5:"09:00";s:7:"timeEnd";s:5:"21:00";}i:1;a:3:{s:7:"weekday";i:2;s:9:"timeStart";s:5:"09:00";s:7:"timeEnd";s:5:"21:00";}i:2;a:3:{s:7:"weekday";i:3;s:9:"timeStart";s:5:"09:00";s:7:"timeEnd";s:5:"21:00";}i:3;a:3:{s:7:"weekday";i:4;s:9:"timeStart";s:5:"09:00";s:7:"timeEnd";s:5:"21:00";}i:4;a:3:{s:7:"weekday";i:5;s:9:"timeStart";s:5:"09:00";s:7:"timeEnd";s:5:"18:00";}i:5;a:3:{s:7:"weekday";i:6;s:9:"timeStart";s:5:"10:00";s:7:"timeEnd";s:5:"17:00";}}';
  $libholi = 'a:9:{i:0;a:3:{s:4:"name";s:6:"Closed";s:9:"dateStart";s:10:"2022-07-02";s:7:"dateEnd";s:10:"2022-07-03";}i:1;a:3:{s:4:"name";s:6:"Closed";s:9:"dateStart";s:10:"2022-07-09";s:7:"dateEnd";s:10:"2022-07-10";}i:2;a:3:{s:4:"name";s:6:"Closed";s:9:"dateStart";s:10:"2022-07-16";s:7:"dateEnd";s:10:"2022-07-17";}i:3;a:3:{s:4:"name";s:6:"Closed";s:9:"dateStart";s:10:"2022-07-23";s:7:"dateEnd";s:10:"2022-07-24";}i:4;a:3:{s:4:"name";s:6:"Closed";s:9:"dateStart";s:10:"2022-07-30";s:7:"dateEnd";s:10:"2022-07-31";}i:5;a:3:{s:4:"name";s:6:"Closed";s:9:"dateStart";s:10:"2022-08-06";s:7:"dateEnd";s:10:"2022-08-07";}i:6;a:3:{s:4:"name";s:6:"Closed";s:9:"dateStart";s:10:"2022-08-13";s:7:"dateEnd";s:10:"2022-08-14";}i:7;a:3:{s:4:"name";s:6:"Closed";s:9:"dateStart";s:10:"2022-08-20";s:7:"dateEnd";s:10:"2022-08-21";}i:8;a:3:{s:4:"name";s:6:"Closed";s:9:"dateStart";s:10:"2022-08-27";s:7:"dateEnd";s:10:"2022-08-28";}}';
  $libir = 'a:0:{}';
  break;
